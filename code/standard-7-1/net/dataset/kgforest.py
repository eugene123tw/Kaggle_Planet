...
KAGGLE_DATA_DIR ='/home/eugene/Documents/Kaggle_Planet/forest-developer/standard-eugene/data'
...
def run_check_dataset():
    dataset = KgForestDataset(  'debug-32',   #'testv2-20522', #'valid-8000', ##'debug-32', ###'train-40479',  ##'train-ordered-20', ##
                                transform=[
                                    #lambda x: randomShiftScaleRotate(x, u=0.75, shift_limit=16, scale_limit=0.1, rotate_limit=45),
                                    #lambda x: randomFlip(x),
                                    #lambda x: randomTranspose(x),
